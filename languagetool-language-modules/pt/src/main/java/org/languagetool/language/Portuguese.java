...
public class Portuguese extends LanguageWithModel {
  ...
  public Language getDefaultLanguageVariant() {
    return Languages.getLanguageForShortCode("pt-BR");
  }
  ...
  public List<Rule> getRelevantRules(ResourceBundle messages, UserConfig userConfig, Language motherTongue, List<Language> altLanguages) throws IOException {
    return Arrays.asList(
            ...
            // Specific to the Brazilian Portuguese build:
            ...
            new BrazilianPortugueseReplaceRule(messages, "/pt/pt-BR/replace.txt", this),
            new PortugueseBarbarismsRule(messages, "/pt/pt-BR/barbarisms.txt", this),
            new PortugueseArchaismsRule(messages, "/pt/pt-BR/archaisms.txt", this),
            new PortugueseClicheRule(messages, "/pt/pt-BR/cliches.txt", this),
            new PortugueseFillerWordsRule(messages, this, userConfig),
            new PortugueseRedundancyRule(messages, "/pt/pt-BR/redundancies.txt", this),
            new PortugueseWordinessRule(messages, "/pt/pt-BR/wordiness.txt", this),
            new PortugueseWikipediaRule(messages, "/pt/pt-BR/wikipedia.txt", this),
